...
export const generateResumePDF = (data: PortfolioData) => {
  ...
  const summary = `Innovative Software Developer with 1.5+ years experience in full-stack development, backend systems, and software engineering. Proficient in React.js, Node.js, Express.js, MongoDB, Spring Boot, Java, OOP principles, and RESTful API design. MCA graduate (2023) from BGSB University with 8.50 CGPA. Expert in modern development practices, cloud and AI-driven tools, designing reliable software architectures for real-world business needs.`
  
  const summaryLines = pdf.splitTextToSize(summary, contentWidth)
  pdf.text(summaryLines, margin, yPosition)
  yPosition += summaryLines.length * 3.2 + 6
  ...
  const competencies = [
    'Full Stack Web Development • Java Programming & OOP • RESTful API Development',
    'MERN Stack (MongoDB, Express.js, React.js, Node.js) • Spring Boot & Microservices',
    'Database Design & SQL Tuning • Cloud Platforms (AWS, Vercel, Render)',
    'Workflow Automation (n8n, Zapier, Make.com) • Software Testing & CI/CD',
    'Responsive Web Design & UI/UX • Agile Methodologies & Version Control (Git)'
  ]
  ...
  competencies.forEach(comp => {
    ...
    yPosition += compLines.length * 3.2 + 1
  })
  yPosition += 5
  ...
  const skillCategories = [
    ...
    { label: 'Tools:', skills: 'Git, GitHub, Postman, VS Code, Eclipse, Figma, AWS, Vercel, Render' }
  ]
